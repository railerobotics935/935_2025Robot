 ...
 */
class IntakeWithTriggers
    : public frc2::CommandHelper<frc2::Command, IntakeWithTriggers> {
 public:
  /**
   ...
   */
  explicit IntakeWithTriggers(IntakeSubsystem* intake, frc::XboxController* operatorController);
